...
%Viitteet kirjallisuuslähteisiin muodostetaan komennolla \texttt{}, josta generoituu tekstiin valitun viittaustyylin mukaisesti muotoiltu viite \citep{christianson_security_2011}, tai \texttt{\textbackslash citep\{latexcompanion,knuth99\}}, josta tekstiin puolestaan generoituu \citep{christianson_security_2011}. 
%Voit esimerkiksi kirjoittaa \citep{christianson_security_2011} viitataksesi julkaisuun, jonka on kirjoittanut \citeauthor{christianson_security_2011} vuonna \citeyear{christianson_security_2011}, kun vain lähde \citet{christianson_security_2011} on oikein lisättynä kirjallisuuslähdetiedostossa (katso miltä nämä näyttävät Latex lähdekoodissa).
