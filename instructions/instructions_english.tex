...
%References are done using \texttt{\textbackslash \citep{$christianson_security_2011$\}}, which generates in text a citation formatted according to the selected style \citep{$christianson_security_2011$}, or \texttt{\textbackslash \citep{$christianson_security_2011$}}, which generates \citep{$christianson_security_2011$}. 
%As examples of a different kinds of citations (see how these look in the Latex source), we can write \citep{$christianson_security_2011$} to refer to the work written by \citeauthor{$christianson_security_2011$} in \citeyear{$christianson_security_2011$}, because the work by \citet{$christianson_security_2011$} appears in the bilbliography included in this template.
