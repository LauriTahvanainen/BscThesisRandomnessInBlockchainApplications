...
\documentclass[finnish,twoside,censored,tkt,networking-track-2020]{HYthesisML} 
...
\title{Satunnaislukujen tuottaminen lohkoketjusovelluksissa}
...
\supervisors{Prof.~K.~Heljanko, FM.~A.~Vainio}

\keywords{blockchain, randomness}
...
\  Networks $\rightarrow$ Network types  $\rightarrow$ Overlay and other logical network structures $\rightarrow$ Peer-to-peer networks\  \\
\  Mathematics of computing  $\rightarrow$ Probability and statistics  $\rightarrow$ Probabilistic reasoning algorithms $\rightarrow$ Random number generation
}}
